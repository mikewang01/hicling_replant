...
def expand_free_rtos_lists_cmd():
        ...
        for symbol in expand_symbols:
                ...
                cmd += "iterate-free_rtos_list " + symbol + "\n"
...
def expand_free_rtos_heap_cmd():
        ...
        cmd += "iterate-freertos-heap ucHeap" + "\n"
...
def usage(argv):
        ...
        print ""
        print "e.g 1 " + argv[0] + " -g arm-none-eabi-gdb-py -f ../../../../../projects/dk_apps/demos/pxp_reporter/Debug_QSPI/pxp_reporter.elf"
        print "Dumps RAM contents, symbols are provided by the elf file. GDB path is provided by the -g argument."
        print ""
        print "e.g 2 " + argv[0] + " -g arm-none-eabi-gdb-py -f ../../../../../projects/dk_apps/demos/pxp_reporter/Debug_QSPI/pxp_reporter.elf -b dump_memory.ihex"
        ...
        print ""
        print "e.g 3 " + argv[0] + " -g arm-none-eabi-gdb-py -f ../../../../../projects/dk_apps/demos/pxp_reporter/Debug_QSPI/pxp_reporter.elf -b dump_memory.bin"
        ...
        print "GDB path is provided by the -g argument."
        print ""
        print "e.g 4 " + argv[0] + " -g arm-none-eabi-gdb-py -f ../../../../../projects/dk_apps/demos/pxp_reporter/Debug_QSPI/pxp_reporter.elf -x ../../../../../doc/DA14680AE.xml"
