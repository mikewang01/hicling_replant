...
class IterateFreeRtosListCommand(gdb.Command):
        ...
        def __init__(self):
                super(IterateFreeRtosListCommand, self).__init__("iterate-free_rtos_list",
                                                                 gdb.COMMAND_DATA,
                                                                 gdb.COMPLETE_SYMBOL)
...
class IterateFreeRtosHeap(gdb.Command):

        def __init__(self):
                super(IterateFreeRtosHeap, self).__init__("iterate-freertos-heap",
                                                 gdb.COMMAND_DATA,
                                                 gdb.COMPLETE_SYMBOL)
