...
{
        if [ "${PRODUCT_ID}" = "DA14680-00" ] || [ "${PRODUCT_ID}" = "DA14681-00" ]
        then
                ./generate_gdb_cmds.py -f ../../../../../doc/DA14680AD.xml -g
                return $?
        elif  [ "${PRODUCT_ID}" = "DA14680-01" ] || [ "${PRODUCT_ID}" = "DA14681-01" ]
        then
                ./generate_gdb_cmds.py -f ../../../../../doc/DA14680AE.xml -g
                return $?
        else
