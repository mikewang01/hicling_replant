...
SUOTA_LOADER_PATH=$sdkroot/sdk/bsp/system/loaders/suota_1_1_loader
...
if [ x"$PRODUCT_ID" == x"DA14680-00" ] ; then
...
shift
if [ -z $1 ] ; then
  boot_loader_bin=$SUOTA_LOADER_PATH/$SUOTA_BUILD_CONFIG/suota_1_1_loader.bin
else
