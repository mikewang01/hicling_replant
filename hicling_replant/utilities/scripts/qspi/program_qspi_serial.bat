...
@echo on
CALL "..\..\..\binaries\cli_programmer.exe" --prod-id %PRODUCT_ID% --enable-uart %ENABLE_UART% --ram-shuffling %RAM_SHUFFLING% COM%comprtnr% write_qspi_exec %IMAGE%
@echo off
goto :Finished
