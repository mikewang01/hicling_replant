...
* @file main.c
*
* @brief cli programmer to programm RAM, FLASH or OTP.
*
...
int main(int argc, char *argv[])
{
        ...
        printf("cli_programmer %d.%02d\n", CLI_VERSION_MAJOR,
                                                                                CLI_VERSION_MINOR);
        printf("Copyright (c) 2015 Dialog Semiconductor\n\n");
        ...
        if (strcmp(argv[p_idx], "gdbserver") == 0) {
                if (prog_gdb_open(&main_opts.gdb_server_config)) {
