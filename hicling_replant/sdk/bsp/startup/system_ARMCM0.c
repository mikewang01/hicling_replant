...
#define qspi_automode_init()
#define qspi_automode_write_flash_page(a, b, c) (c)
#define qspi_automode_erase_flash_sector(a)
...
void SystemInitPost(void)
{
        ...
        /*Retrieve trimming_ok from SystemInitClkSetup() execution */
        ...
        if ((dg_configCODE_LOCATION == NON_VOLATILE_IS_FLASH) || (dg_configPOWER_FLASH == 1)) {
                hw_qspi_set_div(HW_QSPI_DIV_1);         // Use fastest access mode to QSPI Flash
