...
const uint32_t rom_func_addr_table_var[] __attribute__((section("jump_table_mem_area"))) = {
        ...
        (dg_configUSE_LP_CLK != LP_CLK_RCX) ?           // 33. lld_sleep_compensate_func_pos
        ...
        (uint32_t) ASSIGN_BLE_HOOK(custom_preinit),     // [71|60]. custom_preinit_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postinit),    // [72|61]. custom_postinit_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_appinit),     // [73|62]. custom_appinit_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_preloop),     // [74|63]. custom_preloop_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_preschedule), // [75|64]. custom_preschedule_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postschedule),// [76|65]. custom_postschedule_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postschedule_async),  // [77|66]. custom_postschedule_async_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_presleepcheck),       // [78|67]. custom_presleepcheck_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_appsleepset), // [79|68]. custom_appsleepset_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postsleepcheck),      // [80|69]. custom_postsleepcheck_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_presleepenter),       // [81|70]. custom_presleepenter_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postsleepexit),       // [82|71]. custom_postsleepexit_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_prewakeup),   // [83|72]. custom_prewakeup_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_postwakeup),  // [84|73]. custom_postwakeup_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_preidlecheck),// [85|74]. custom_preidlecheck_func_pos
        (uint32_t) ASSIGN_BLE_HOOK(custom_pti_set),     // [86|75]. custom_pti_set_func_pos
...
# endif
        ...
        3,                                      // 27. rwble_priority_mconnect_pos
        3,                                      // 28. rwble_priority_sconnect_pos
        5,                                      // 29. rwble_priority_adv_hdc_pos
