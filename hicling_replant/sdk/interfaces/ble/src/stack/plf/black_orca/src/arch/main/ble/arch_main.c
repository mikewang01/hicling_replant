...
void ble_stack_init(void)
{
        ...
        CHECK_AND_CALL_VOID(custom_preinit);
...
#undef BLE_BLE_CNTL2_REG_DIAG5_Pos
        ...
        CHECK_AND_CALL_VOID(custom_postinit);
        ...
        CHECK_AND_CALL_VOID(custom_appinit);
...
{
        CHECK_AND_CALL_VOID(custom_prewakeup);
        ...
        CHECK_AND_CALL_VOID(custom_postwakeup);
}
...
void ble_platform_initialization(void)
{
...
#if RWBLE_SW_VERSION_MAJOR >= 8
        ble_duplicate_filter_max = 10;  //BLE_DUPLICATE_FILTER_MAX;     ////this is the maximum spec value but it could require large amounts of heap 255*11=2805
        ...
        CUSTOM_INIT(custom_preinit_func_pos, custom_preinit, unsigned char (*)(void));
        CUSTOM_INIT(custom_postinit_func_pos, custom_postinit, unsigned char (*)(void));
        CUSTOM_INIT(custom_appinit_func_pos, custom_appinit, unsigned char (*)(void));
        CUSTOM_INIT(custom_preloop_func_pos, custom_preloop, unsigned char (*)(void));
        CUSTOM_INIT(custom_preschedule_func_pos, custom_preschedule, unsigned char (*)(void));
        CUSTOM_INIT(custom_postschedule_func_pos, custom_postschedule, unsigned char (*)(void));
        CUSTOM_INIT(custom_postschedule_async_func_pos, custom_postschedule_async, unsigned char (*)(void));
        CUSTOM_INIT(custom_presleepcheck_func_pos, custom_presleepcheck, unsigned char (*)(void));
        CUSTOM_INIT(custom_appsleepset_func_pos, custom_appsleepset, unsigned char (*)(void *));
        CUSTOM_INIT(custom_postsleepcheck_func_pos, custom_postsleepcheck, unsigned char (*)(void *));
        CUSTOM_INIT(custom_presleepenter_func_pos, custom_presleepenter, unsigned char (*)(void *));
        CUSTOM_INIT(custom_postsleepexit_func_pos, custom_postsleepexit, unsigned char (*)(void *));
        CUSTOM_INIT(custom_prewakeup_func_pos, custom_prewakeup, unsigned char (*)(void));
        CUSTOM_INIT(custom_postwakeup_func_pos, custom_postwakeup, unsigned char (*)(void));
        CUSTOM_INIT(custom_preidlecheck_func_pos, custom_preidlecheck, unsigned char (*)(void));
...
static int ble_rwip_sleep(uint32_t *sleep_duration)
{
        ...
        do
        {
                 ...
                 *
                 * Thus, the window [200, 40] guarantees that there will be enough time
                 ...
                 * hardware!
                 *
                 * Note that 200 covers the case up to a ~15.5KHz RCX clock, which is too high.
 ...
 *
 */
int ble_sleep(bool forever, uint32_t *wakeup_time)
{
        ...
        if (!rf_in_sleep) {
                ret = ble_rwip_sleep(&sleep_duration);
                if (ret == 1) {
