...
#define mainBIT_EVENT_ADV_END           (1 << 4)
#endif
...
/**
 * \brief Return public static address
 *
 * This will be either address read from NVMS or default address.
 * Since this address does not change once it has been loaded, it's safe to call it at any time
 * from any task
 *
 * \return public static address (no address type included)
 *
 */
