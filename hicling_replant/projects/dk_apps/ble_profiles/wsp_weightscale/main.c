...
static void periph_init(void)
{
        ...
        for (pin = CFG_HW_GPIO_START_PIN_SELECT_USER;
                            pin < (CFG_HW_GPIO_START_PIN_SELECT_USER + CFG_UDS_MAX_USERS); pin++) {

                hw_gpio_configure_pin(CFG_HW_GPIO_PORT_SELECT_USER, pin, HW_GPIO_MODE_INPUT_PULLUP,
