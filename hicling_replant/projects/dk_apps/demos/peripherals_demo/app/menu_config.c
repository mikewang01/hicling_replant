...
MENU_ITEM_PARM("send NEC protocol command (repeat)",    irgen_send_nec,                 0)
...
MENU_ITEM_VOID("Calibrate",                             gpadc_calibrate)
...
MENU_ITEM_VOID("Go to Deep Sleep Mode",                 power_mode_deep_sleep)
...
TASKLIST_BEGIN()
TASKLIST_ENTRY(uart_print, 1, 400, task_uart_printf_init_func, task_uart_printf_func, NULL)
#if CFG_DEMO_HW_I2C
...
#endif
#if CFG_DEMO_AD_UART
TASKLIST_ENTRY(uart_writer1, 1, 400, task_ad_uart_worker_init, task_ad_uart_worker_func, (void *) 0)
TASKLIST_ENTRY(uart_writer2, 1, 400, task_ad_uart_worker_init, task_ad_uart_worker_func, (void *) 1)
#endif
#if CFG_DEMO_AD_SPI
TASKLIST_ENTRY(at45_user, 1, 450, NULL, task_ad_spi_at45_worker_func, NULL)
#endif
#if CFG_DEMO_AD_GPADC
TASKLIST_ENTRY(gpadc_user, 1, 800, NULL, task_ad_gpadc_worker_func, NULL)
#endif
#if CFG_DEMO_AD_TEMPSENS
TASKLIST_ENTRY(tempsens_user, 1, 800, NULL, task_temperature_sensor_worker_func, NULL)
#endif
#if CFG_DEMO_SENSOR_BOARD
TASKLIST_ENTRY(sensor_board_user, 1, 800, NULL, task_sensor_board_worker_func, NULL)
#endif
TASKLIST_END()
