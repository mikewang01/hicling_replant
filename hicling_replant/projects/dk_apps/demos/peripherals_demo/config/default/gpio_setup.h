...
/* Timer 0 */
#if dg_configUSE_FPGA || dg_configBLACK_ORCA_MB_REV == BLACK_ORCA_MB_REV_A
#       define CFG_GPIO_TIMER0_PORT     (HW_GPIO_PORT_1)
#       define CFG_GPIO_TIMER0_PIN      (HW_GPIO_PIN_4)
...
#       define CFG_GPIO_TIMER1_PWM_PIN  (HW_GPIO_PIN_4)
#elif dg_configBLACK_ORCA_MB_REV == BLACK_ORCA_MB_REV_B
#       define CFG_GPIO_TIMER1_PWM_PORT (HW_GPIO_PORT_1)
