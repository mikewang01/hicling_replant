...
#define dg_configSUOTA_1_1_SUPPORT              1
...
#define dg_configCACHEABLE_QSPI_AREA_LEN        NVMS_LOG_PART_start
...
#define defaultBLE_PPCP_INTERVAL_MIN            (400)   // 400 * 1.25 ms = 500 ms
#define defaultBLE_PPCP_INTERVAL_MAX            (600)   // 600 * 1.25 ms = 750 ms
#define defaultBLE_PPCP_SLAVE_LATENCY           (0)     // 0 events
#define defaultBLE_PPCP_SUP_TIMEOUT             (600)   // 600 * 10 ms = 6000 ms
