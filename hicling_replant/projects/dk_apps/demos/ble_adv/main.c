...
TaskStatus_t pxTaskStatusArray[mainMAX_NB_OF_TASKS * sizeof( TaskStatus_t )];
volatile UBaseType_t uxNbOfTasks, uxNbOfTaskEntries;
...
void vApplicationIdleHook( void )
{
	 ...
	 */
	uxNbOfTasks = uxTaskGetNumberOfTasks();

	// Generate raw status information about each task.
	uxNbOfTaskEntries = uxTaskGetSystemState(pxTaskStatusArray, mainMAX_NB_OF_TASKS,
	                        &ulTotalRunTime);
