/***************************************************************************//**
 * @file standard_binary.h
 * @brief Definitions to allow binary representations of bytes.
 *
 * @details This file defines a set of constants that can be used to specify
 *          bytes using a "b" notation, similar to the "0x" notation of hex
 *          numbers.  It is a pretty brute-force method, but is very useful for
 *          setting flag bits in a mask.
 *
 * @note Unfortunately, we can't use a "0b" notation due to the fact that some
 *       preprocessors (such as the IAR MSP430 compiler) will not allow even
 *       <code>\#define</code>d symbols to start with a numeral.
 *
...
#ifndef __STANDARD_BINARY_H__
#define __STANDARD_BINARY_H__
