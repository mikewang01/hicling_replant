...
#ifdef EXTERNAL_FLASH_SIZE_1024KB
	...
	#define FAT_FLASH_PAGE_ALL              256
	#define FAT_FLASH_START_PAGE            0
	...
	#define FS_DATA_CLUSTER_MAX 7168  // 1024 KB - 64 KB (APP) - 64 KB (SYSTEM) = 896 KB
  ...
  // System linking cridentials
	...
	#define FLASH_SIZE                      (1048576) /* 1024 KB */

	// Non-FAT cling application space starting address cluster fat manages, 
	#define CLING_APP_SPACE                 (FLASH_SIZE - FAT_CLING_APP_SPACE_SIZE)  /* 1024 KB - 64 KB */
	#define CLING_APP_PAGE_START            (240) /* 256 pages - 16 pages. */
