...
void ble_peripheral_task(void *params)
{
        ...
        ble_gap_device_name_set("Vband 123a", ATT_PERM_READ);
        ...
        struct task_handle_sets *p = (struct task_handle_sets*)params;
        btle_fsm_init();
