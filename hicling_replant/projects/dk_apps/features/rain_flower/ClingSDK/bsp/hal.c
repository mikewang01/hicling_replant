...
//	}
//
//	NOR_pageProgram(addr, 32, buf_in);
//
//	NOR_readData(addr, 32, buf_out);
//
//	Y_SPRINTF("[SYSTEM] nflash test read data :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d :%d",buf_out[0]
//	,buf_out[1],buf_out[2],buf_out[3],buf_out[4],buf_out[5],buf_out[6],buf_out[7],buf_out[8],buf_out[9],buf_out[10],buf_out[11],buf_out[12]
//	,buf_out[13],buf_out[14],buf_out[15],buf_out[16],buf_out[17]);
//}
//
//#endif
//
