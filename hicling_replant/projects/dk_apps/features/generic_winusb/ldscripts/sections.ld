...
/*
 * No need for BLE support in this project.
 *
...
/*
 * This check should not be done in this project. -- Check if RAM does not overlap ROM variables  
 *      ASSERT(ORIGIN(RAM) + LENGTH(RAM) < 0x7FDEC00, "ROM variables region (starting at 0x7FDEC00) overflowed by RAM")
 */

/*
 * This check should not be done in this project. -- Check if RetRAM0 does not overlap ROM variables
